...
public class Sintatico implements Constants
{
    ...
    private boolean step() throws LexicalError, SyntaticError, SemanticError {
        ...
        if (currentToken.getId() == 2) {
            throw new LexicalError("palavra reservada invalida", currentToken.getPosition(), currentToken.getLexeme());
        }
        ...
        if (x == EPSILON) {
            ...
            try {
                semanticAnalyser.executeAction(x - FIRST_SEMANTIC_ACTION, previousToken); // Passa o previousToken
            } catch (SemanticError e) {
                // Lança o erro com a posição do previousToken
                throw new SemanticError(e.getMessage(), previousToken.getPosition());
            }
        return false;
    }
